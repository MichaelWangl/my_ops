...
{
    InitAndRunScaledMaskedSoftmaxGradV2Case(4, 4, 1024, 128, 4, 4,                  // B, N, S1, S2, maskB, maskN
...
{
    InitAndRunScaledMaskedSoftmaxGradV2Case(4, 4, 1024, 128, 1, 4,                  // B, N, S1, S2, maskB, maskN
                                            float(0.9), false, ge::DT_BF16,         // scale, fixTriuMask, yGrad dtype
                                            ge::DT_BOOL, ge::GRAPH_SUCCESS, 1000);  // mask dtype, status, tilingKey
}
...
{
    InitAndRunScaledMaskedSoftmaxGradV2Case(4, 4, 1024, 128, 4, 1,                  // B, N, S1, S2, maskB, maskN
                                            float(0.9), false, ge::DT_BF16,         // scale, fixTriuMask, yGrad dtype
                                            ge::DT_BOOL, ge::GRAPH_SUCCESS, 1000);  // mask dtype, status, tilingKey
}
...
{
    InitAndRunScaledMaskedSoftmaxGradV2Case(4, 4, 1024, 128, 1, 1,                  // B, N, S1, S2, maskB, maskN
                                            float(0.9), false, ge::DT_BF16,         // scale, fixTriuMask, yGrad dtype
                                            ge::DT_BOOL, ge::GRAPH_SUCCESS, 1000);  // mask dtype, status, tilingKey
}
...
{
    InitAndRunScaledMaskedSoftmaxGradV2Case(4, 4, 1024, 2048, 4, 4,                  // B, N, S1, S2, maskB, maskN
                                            float(0.9), false, ge::DT_BF16,          // scale, fixTriuMask, yGrad dtype
...
{
    InitAndRunScaledMaskedSoftmaxGradV2Case(4, 4, 1024, 2048, 1, 4,                  // B, N, S1, S2, maskB, maskN
                                            float(0.9), false, ge::DT_BF16,          // scale, fixTriuMask, yGrad dtype
                                            ge::DT_BOOL, ge::GRAPH_SUCCESS, 2000);   // mask dtype, status, tilingKey
}
...
{
    InitAndRunScaledMaskedSoftmaxGradV2Case(4, 4, 1024, 2048, 4, 1,                  // B, N, S1, S2, maskB, maskN
                                            float(0.9), false, ge::DT_BF16,          // scale, fixTriuMask, yGrad dtype
                                            ge::DT_BOOL, ge::GRAPH_SUCCESS, 2000);   // mask dtype, status, tilingKey
}
...
{
    InitAndRunScaledMaskedSoftmaxGradV2Case(4, 4, 1024, 2048, 1, 1,                  // B, N, S1, S2, maskB, maskN
                                            float(0.9), false, ge::DT_BF16,          // scale, fixTriuMask, yGrad dtype
                                            ge::DT_BOOL, ge::GRAPH_SUCCESS, 2000);   // mask dtype, status, tilingKey
}
