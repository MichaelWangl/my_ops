...
{
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.commtype %d", rcsTiling.commtype);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.subtype %d", rcsTiling.subtype);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.rankDim %d", rcsTiling.rankDim);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.rankID %d", rcsTiling.rankID);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.tileCnt %d", rcsTiling.tileCnt);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.tailM %d", rcsTiling.tailM);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.tailCnt %d", rcsTiling.tailCnt);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.isTransA %d", rcsTiling.isTransposeA);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.isTransB %d", rcsTiling.isTransposeB);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.rankM %d", rcsTiling.rankM);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.rankN %d", rcsTiling.rankN);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.rankK %d", rcsTiling.rankK);
    OPS_LOG_D("AllGatherMatmul", " rcsTiling.gatherIndex %d", rcsTiling.gatherIndex);
...
{
    OPS_LOG_D("AllGatherMatmul", " tileL2Tiling.mL2TileCnt %d", tileL2Tiling.mL2TileCnt);
    OPS_LOG_D("AllGatherMatmul", " tileL2Tiling.nL2TileCnt %d", tileL2Tiling.nL2TileCnt);
    OPS_LOG_D("AllGatherMatmul", " tileL2Tiling.mTileBlocks %d", tileL2Tiling.mTileBlocks);
    OPS_LOG_D("AllGatherMatmul", " tileL2Tiling.nTileBlocks %d", tileL2Tiling.nTileBlocks);
    OPS_LOG_D("AllGatherMatmul", " tileL2Tiling.mTailBlocks %d", tileL2Tiling.mTailBlocks);
    OPS_LOG_D("AllGatherMatmul", " tileL2Tiling.nTailBlocks %d", tileL2Tiling.nTailBlocks);
    OPS_LOG_D("AllGatherMatmul", " tileL2Tiling.rankTileNum %d", tileL2Tiling.rankTileNum);
    OPS_LOG_D("AllGatherMatmul", " tileL2Tiling.calcOrder %d", tileL2Tiling.calcOrder);
    OPS_LOG_D("AllGatherMatmul", " tileL2Tiling.enableL2Tile %d", tileL2Tiling.enableL2Tile);
}
}
                                       ...
                                       mc2tiling::TilingArgs& args)
{
    ...
    OPS_LOG_D("AllGatherMatmul", "workspaces[0] size is %ld.", workspaces[0]);
    ...
    if (tilingData.param.rankID == 0) {
        OPS_LOG_D("AllGatherMatmul", "workspace size %ld.", workspaces[0]);
...
static bool NeedGatherOut(const gert::TilingContext* context) {
  ...
  if (gatherOut != nullptr) {
    for (unsigned int i = 0;i < gatherOut->GetStorageShape().GetDimNum(); i++) {
        ...
        OPS_LOG_D("AllGatherMatmul", "gatherOut StorageShape[%d] is %ld", i, gatherOut->GetStorageShape().GetDim(i));
    }
  }
