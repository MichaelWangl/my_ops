...
{
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.rankDim %d", rcsTiling.rankDim);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.rankID %d", rcsTiling.rankID);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.commtype %d", rcsTiling.commtype);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.subtype %d", rcsTiling.subtype);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.tileCnt %d", rcsTiling.tileCnt);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.tailM %d", rcsTiling.tailM);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.tailCnt %d", rcsTiling.tailCnt);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.biasLen %d", rcsTiling.biasLen);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.isAdd %d", rcsTiling.isAdd);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.rankM %d", rcsTiling.rankM);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.rankN %d", rcsTiling.rankN);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.rankK %d", rcsTiling.rankK);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.gatherIndex %d", rcsTiling.gatherIndex);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.isTransA %d", rcsTiling.isTransposeA);
    OPS_LOG_D("MatmulReduceScatter", " rcsTiling.isTransB %d", rcsTiling.isTransposeB);
	OPS_LOG_D("MatmulReduceScatter", " rcsTiling.storageGather %d", rcsTiling.storageGather);
...
{
    OPS_LOG_D("MatmulReduceScatter", " tileL2Tiling.mL2TileCnt %d", tileL2Tiling.mL2TileCnt);
    OPS_LOG_D("MatmulReduceScatter", " tileL2Tiling.nL2TileCnt %d", tileL2Tiling.nL2TileCnt);
    OPS_LOG_D("MatmulReduceScatter", " tileL2Tiling.mTileBlocks %d", tileL2Tiling.mTileBlocks);
    OPS_LOG_D("MatmulReduceScatter", " tileL2Tiling.nTileBlocks %d", tileL2Tiling.nTileBlocks);
    OPS_LOG_D("MatmulReduceScatter", " tileL2Tiling.mTailBlocks %d", tileL2Tiling.mTailBlocks);
    OPS_LOG_D("MatmulReduceScatter", " tileL2Tiling.nTailBlocks %d", tileL2Tiling.nTailBlocks);
    OPS_LOG_D("MatmulReduceScatter", " tileL2Tiling.rankTileNum %d", tileL2Tiling.rankTileNum);
    OPS_LOG_D("MatmulReduceScatter", " tileL2Tiling.calcOrder %d", tileL2Tiling.calcOrder);
    OPS_LOG_D("MatmulReduceScatter", " tileL2Tiling.enableL2Tile %d", tileL2Tiling.enableL2Tile);
}
}
...
static void SetReduceScatterTilingArgs(gert::TilingContext* context, mc2tiling::TilingArgs& args)
{
	...
	if (aShape->GetStorageShape().GetDim(1) != bShape->GetStorageShape().GetDim(0)) {
        OPS_LOG_D(context->GetNodeName(), "A.shape(1) %lu B.shape(0) %lu, istransB = %d",
                                                    ...
                                                    mc2tiling::TilingArgs& args)
{
    ...
    OPS_LOG_D("MatmulReduceScatter", " workspaces[0] size %ld, biasLen %d.", workspaces[0], biasLen);
    ...
    if (tilingData.param.rankID == 0) {
        OPS_LOG_D("MatmulReduceScatter", "workspace size %ld", workspaces[0]);
