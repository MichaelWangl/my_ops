 ...
 */
ASCENDC_EXTERN_C ge::graphStatus Tiling4MoeTokenPermuteGrad(gert::TilingContext *context)
{
...
ASCENDC_EXTERN_C ge::graphStatus TilingPrepareForMoeTokenPermuteGrad(gert::TilingParseContext *context)
{
