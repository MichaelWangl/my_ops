...
static void PrintInfo(gert::TilingContext* context) {
  OPS_LOG_D(context, " batchSize=%ld.",      tiling.ropeInterleavedParams.get_batchSize());
  OPS_LOG_D(context, " seqLen=%ld.",         tiling.ropeInterleavedParams.get_seqLen());
  OPS_LOG_D(context, " numHeads=%ld.",       tiling.ropeInterleavedParams.get_numHeads());
  OPS_LOG_D(context, " headDim=%ld.",        tiling.ropeInterleavedParams.get_headDim());
  OPS_LOG_D(context, " frontCoreNum=%ld.",   tiling.ropeInterleavedParams.get_frontCoreNum());
  OPS_LOG_D(context, " tailCoreNum=%ld.",    tiling.ropeInterleavedParams.get_tailCoreNum());
  OPS_LOG_D(context, " coreCalcNum=%ld.",    tiling.ropeInterleavedParams.get_coreCalcNum());
  OPS_LOG_D(context, " coreCalcTail=%ld.",   tiling.ropeInterleavedParams.get_coreCalcTail());
  OPS_LOG_D(context, " ubCalcNum=%ld.",      tiling.ropeInterleavedParams.get_ubCalcNum());
  OPS_LOG_D(context, " ubCalcLoop=%ld.",     tiling.ropeInterleavedParams.get_ubCalcLoop());
  OPS_LOG_D(context, " ubCalcTail=%ld.",     tiling.ropeInterleavedParams.get_ubCalcTail());
  OPS_LOG_D(context, " ubCalcTailNum=%ld.",  tiling.ropeInterleavedParams.get_ubCalcTailNum());
  OPS_LOG_D(context, " ubCalcTailLoop=%ld.", tiling.ropeInterleavedParams.get_ubCalcTailLoop());
  OPS_LOG_D(context, " ubCalcTailTail=%ld.", tiling.ropeInterleavedParams.get_ubCalcTailTail());
  OPS_LOG_D(context, " ubCalcBNum=%ld.",     tiling.ropeInterleavedParams.get_ubCalcBNum());
  OPS_LOG_D(context, " ubCalcBLoop=%ld.",    tiling.ropeInterleavedParams.get_ubCalcBLoop());
  OPS_LOG_D(context, " ubCalcBTail=%ld.",    tiling.ropeInterleavedParams.get_ubCalcBTail());
  OPS_LOG_D(context, " ubCalcNNum=%ld.",     tiling.ropeInterleavedParams.get_ubCalcNNum());
  OPS_LOG_D(context, " ubCalcNLoop=%ld.",    tiling.ropeInterleavedParams.get_ubCalcNLoop());
  OPS_LOG_D(context, " ubCalcNTail=%ld.",    tiling.ropeInterleavedParams.get_ubCalcNTail());
}
...
ge::graphStatus Tiling4RopeInterleaved(gert::TilingContext* context) {
  ...
  OPS_LOG_D(context, "[tilingKey]: %ld", context->GetTilingKey());
