...
inline void RotateHalfTiling::PrintTilingParams() {
  ...
  OPS_LOG_D(context, ">>> tilingKey:           %ld", tilingKey);
  OPS_LOG_D(context, ">>> coreNum:             %ld", coreNum);
  OPS_LOG_D(context, ">>> tilingMode:          %ld", tilingData_.get_tilingMode());
  OPS_LOG_D(context, ">>> tilingDtype:         %ld", tilingDtype);
  OPS_LOG_D(context, ">>> gmLength:            %ld", tilingData_.get_gmLength());
  OPS_LOG_D(context, ">>> broadcastFirstDim:   %ld", tilingData_.get_broadcastFirstDim());
  OPS_LOG_D(context, ">>> broadcastSecondDim:  %ld", tilingData_.get_broadcastSecondDim());
  OPS_LOG_D(context, ">>> dLength:             %ld", tilingData_.get_dLength());
  OPS_LOG_D(context, ">>> halfDLength:         %ld", tilingData_.get_halfDLength());
  OPS_LOG_D(context, ">>> halfDPadLength:      %ld", tilingData_.get_halfDPadLength());
  OPS_LOG_D(context, ">>> dPadLength:          %ld", tilingData_.get_dPadLength());
  OPS_LOG_D(context, ">>> isAligned:           %ld", tilingData_.get_isAligned());
  OPS_LOG_D(context, ">>> totalSLines:         %ld", tilingData_.get_totalSLines());
  OPS_LOG_D(context, ">>> storeSLines:         %ld", tilingData_.get_storeSLines());
  OPS_LOG_D(context, ">>> storeDataLength:     %ld", tilingData_.get_storeDataLength());
  OPS_LOG_D(context, ">>> storePadDataLength:  %ld", tilingData_.get_storePadDataLength());
  OPS_LOG_D(context, ">>>>>>>>>>>>>>>       former core tiling data      <<<<<<<<<<<<<<<<");
  OPS_LOG_D(context, ">>> formerCoreNum:             %ld", tilingData_.get_formerCoreNum());
  OPS_LOG_D(context, ">>> formerSLines:              %ld", tilingData_.get_formerSLines());
  OPS_LOG_D(context, ">>> formerUbLoop:              %ld", tilingData_.get_formerUbLoop());
  OPS_LOG_D(context, ">>> formerUbLast:              %ld", tilingData_.get_formerUbLast());
  OPS_LOG_D(context, ">>> formerXDataLength:         %ld", tilingData_.get_formerXDataLength());
  OPS_LOG_D(context, ">>> formerRDataLength:         %ld", tilingData_.get_formerRDataLength());
  OPS_LOG_D(context, ">>> formerXCoreOffset:         %ld", tilingData_.get_formerXCoreOffset());
  OPS_LOG_D(context, ">>> formerRCoreOffset:         %ld", tilingData_.get_formerRCoreOffset());
  OPS_LOG_D(context, ">>> formerUbLastDataLength:    %ld", tilingData_.get_formerUbLastDataLength());
  OPS_LOG_D(context, ">>> formerUbLastPadDataLength: %ld", tilingData_.get_formerUbLastPadDataLength());
  OPS_LOG_D(context, ">>>>>>>>>>>>>>>        tail core tiling data        <<<<<<<<<<<<<<<<");
  OPS_LOG_D(context, ">>> tailCoreNum:               %ld", tilingData_.get_tailCoreNum());
  OPS_LOG_D(context, ">>> tailSLines:                %ld", tilingData_.get_tailSLines());
  OPS_LOG_D(context, ">>> tailUbLoop:                %ld", tilingData_.get_tailUbLoop());
  OPS_LOG_D(context, ">>> tailUbLast:                %ld", tilingData_.get_tailUbLast());
  OPS_LOG_D(context, ">>> tailXDataLength:           %ld", tilingData_.get_tailXDataLength());
  OPS_LOG_D(context, ">>> tailRDataLength:           %ld", tilingData_.get_tailRDataLength());
  OPS_LOG_D(context, ">>> tailUbLastDataLength:      %ld", tilingData_.get_tailUbLastDataLength());
  OPS_LOG_D(context, ">>> tailUbLastPadDataLength:   %ld", tilingData_.get_tailUbLastPadDataLength());
...
ge::graphStatus RotateHalfTiling::CheckShapeSupport(const gert::Shape& xShape, const gert::Shape& cosShape,
  ...
  if (dLength > D_LENGTH_LIMIT) {
    OPS_LOG_E(context, "input last dim (head_dim) should be less than %ld.", D_LENGTH_LIMIT);
    return ge::GRAPH_FAILED;
  }
  ...
  if (cosDLength != dLength) {
    OPS_LOG_E(context, "input last dim (head_dim) should be equal, but get x [%ld] and cos [%ld].", dLength, cosDLength);
    return ge::GRAPH_FAILED;
  }
