...
#include "aclnn_scaled_masked_softmax_grad.h"
...
aclnnStatus aclnnScaledMaskedSoftmaxGradGetWorkspaceSize(const aclTensor* gradOutput, const aclTensor* y,
...
aclnnStatus aclnnScaledMaskedSoftmaxGrad(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
