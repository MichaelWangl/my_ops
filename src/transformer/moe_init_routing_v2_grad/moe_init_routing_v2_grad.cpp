...
extern "C" __global__ __aicore__ void moe_init_routing_v2_grad(GM_ADDR gradExpandedX, GM_ADDR expandedRowIdx,
  ...
  constexpr uint64_t MOE_INIT_ROUTING_V2_GRAD_DROPLESS_FLOAT = 1000UL;
  constexpr uint64_t MOE_INIT_ROUTING_V2_GRAD_DROPLESS_FLOAT16 = 1001UL;
  constexpr uint64_t MOE_INIT_ROUTING_V2_GRAD_DROPLESS_BF16 = 1002UL;
  constexpr uint64_t MOE_INIT_ROUTING_V2_GRAD_ACTIVATE_FLOAT = 1010UL;
  constexpr uint64_t MOE_INIT_ROUTING_V2_GRAD_ACTIVATE_FLOAT16 = 1011UL;
  constexpr uint64_t MOE_INIT_ROUTING_V2_GRAD_ACTIVATE_BF16 = 1012UL;
  constexpr uint64_t MOE_INIT_ROUTING_V2_GRAD_POSITION_PAD0_FLOAT = 1100UL;
  constexpr uint64_t MOE_INIT_ROUTING_V2_GRAD_POSITION_PAD0_FLOAT16 = 1101UL;
  constexpr uint64_t MOE_INIT_ROUTING_V2_GRAD_POSITION_PAD0_BF16 = 1102UL;
