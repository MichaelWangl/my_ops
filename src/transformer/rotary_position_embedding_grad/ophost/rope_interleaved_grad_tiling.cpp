...
namespace optiling {
  ...
  static void PrintInfo(gert::TilingContext* context) {
      OPS_LOG_D(context, " batchSize=%ld.", tiling.ropeInterleavedGradParams.get_batchSize());
      OPS_LOG_D(context, " seqLen=%ld.", tiling.ropeInterleavedGradParams.get_seqLen());
      OPS_LOG_D(context, " numHeads=%ld.", tiling.ropeInterleavedGradParams.get_numHeads());
      OPS_LOG_D(context, " headDim=%ld.", tiling.ropeInterleavedGradParams.get_headDim());
      OPS_LOG_D(context, " alignHeadDim=%ld.", tiling.ropeInterleavedGradParams.get_alignHeadDim());
      OPS_LOG_D(context, " padHeadDim=%ld.", tiling.ropeInterleavedGradParams.get_padHeadDim());
      OPS_LOG_D(context, " frontCoreNum=%ld.", tiling.ropeInterleavedGradParams.get_frontCoreNum());
      OPS_LOG_D(context, " tailCoreNum=%ld.", tiling.ropeInterleavedGradParams.get_tailCoreNum());
      OPS_LOG_D(context, " seqFrontLen=%ld.", tiling.ropeInterleavedGradParams.get_seqFrontLen());
      OPS_LOG_D(context, " seqTailLen=%ld.", tiling.ropeInterleavedGradParams.get_seqTailLen());

      OPS_LOG_D(context, " seqFrontCalcNum=%ld.", tiling.ropeInterleavedGradParams.get_seqFrontCalcNum());
      OPS_LOG_D(context, " seqFrontCalcLoop=%ld.", tiling.ropeInterleavedGradParams.get_seqFrontCalcLoop());
      OPS_LOG_D(context, " seqFrontCalcTail=%ld.", tiling.ropeInterleavedGradParams.get_seqFrontCalcTail());
      OPS_LOG_D(context, " seqTailCalcNum=%ld.", tiling.ropeInterleavedGradParams.get_seqTailCalcNum());
      OPS_LOG_D(context, " seqTailCalcLoop=%ld.", tiling.ropeInterleavedGradParams.get_seqTailCalcLoop());
      OPS_LOG_D(context, " seqTailCalcTail=%ld.", tiling.ropeInterleavedGradParams.get_seqTailCalcTail());
      OPS_LOG_D(context, " numHeadsLength=%ld.", tiling.ropeInterleavedGradParams.get_numHeadsLength());
      OPS_LOG_D(context, " numHeadsLoop=%ld.", tiling.ropeInterleavedGradParams.get_numHeadsLoop());
      OPS_LOG_D(context, " numHeadsTail=%ld.", tiling.ropeInterleavedGradParams.get_numHeadsTail());
      OPS_LOG_D(context, " batchNumHeadsLength=%ld.", tiling.ropeInterleavedGradParams.get_batchNumHeadsLength());
      OPS_LOG_D(context, " batchNumHeadsLoop=%ld.", tiling.ropeInterleavedGradParams.get_batchNumHeadsLoop());
      OPS_LOG_D(context, " batchNumHeadsTail=%ld.", tiling.ropeInterleavedGradParams.get_batchNumHeadsTail());
      OPS_LOG_D(context, " layout=%ld.", tiling.ropeInterleavedGradParams.get_layout());
  }
