...
{
    OPS_LOG_D(context, "layout = %ld", tiling.ropeHalfGradParams.get_layout());
    OPS_LOG_D(context, "xShapeSize = %ld", tiling.ropeHalfGradParams.get_xShapeSize());
    OPS_LOG_D(context, "cosShapeSize = %ld", tiling.ropeHalfGradParams.get_cosShapeSize());
    OPS_LOG_D(context, "dimB = %ld", tiling.ropeHalfGradParams.get_dimB());
    OPS_LOG_D(context, "dimS = %ld", tiling.ropeHalfGradParams.get_dimS());
    OPS_LOG_D(context, "dimN = %ld", tiling.ropeHalfGradParams.get_dimN());
    OPS_LOG_D(context, "dimD = %ld", tiling.ropeHalfGradParams.get_dimD());
    OPS_LOG_D(context, "cosDimB = %ld", tiling.ropeHalfGradParams.get_cosDimB());
    OPS_LOG_D(context, "cosDimN = %ld", tiling.ropeHalfGradParams.get_cosDimN());
    OPS_LOG_D(context, "halfDimDAlignNum = %ld", tiling.ropeHalfGradParams.get_halfDimDAlignNum());

    OPS_LOG_D(context, "coreData = %ld", tiling.ropeHalfGradParams.get_coreData());
    OPS_LOG_D(context, "coreLast = %ld", tiling.ropeHalfGradParams.get_coreLast());
    OPS_LOG_D(context, "copyLoop = %ld", tiling.ropeHalfGradParams.get_copyLoop());
    OPS_LOG_D(context, "copyTail = %ld", tiling.ropeHalfGradParams.get_copyTail());
    OPS_LOG_D(context, "lastCopyLoop = %ld", tiling.ropeHalfGradParams.get_lastCopyLoop());
    OPS_LOG_D(context, "lastCopyTail = %ld", tiling.ropeHalfGradParams.get_lastCopyTail());
    OPS_LOG_D(context, "alignUbSize = %ld", tiling.ropeHalfGradParams.get_alignUbSize());
    OPS_LOG_D(context, "calcUbSize = %ld", tiling.ropeHalfGradParams.get_calcUbSize());
    OPS_LOG_D(context, "coreUsed = %ld", tiling.ropeHalfGradParams.get_coreUsed());
    OPS_LOG_D(context, "coreNum = %ld", tiling.ropeHalfGradParams.get_coreNum());

    OPS_LOG_D(context, "firstReduce = %ld", tiling.ropeHalfGradParams.get_firstReduce());
    OPS_LOG_D(context, "secondReduce = %ld", tiling.ropeHalfGradParams.get_secondReduce());
    OPS_LOG_D(context, "ubLoopGap = %ld", tiling.ropeHalfGradParams.get_ubLoopGap());
    OPS_LOG_D(context, "blockLenInner = %ld", tiling.ropeHalfGradParams.get_blockLenInner());
    OPS_LOG_D(context, "strideInner = %ld", tiling.ropeHalfGradParams.get_strideInner());
    OPS_LOG_D(context, "blockLenPadInner = %ld", tiling.ropeHalfGradParams.get_blockLenPadInner());
    OPS_LOG_D(context, "stridePadInner = %ld", tiling.ropeHalfGradParams.get_stridePadInner());
}
...
static bool RopeHalfGradInitSplitInfo(const gert::TilingContext* context)
{
    ...
    if (halfDimDAlignNum * 2 > alignUbSize || alignUbSize == 0 || calcUbSize == 0) {
        OPS_LOG_E(context, "reserveAlignNum = %ld too large, aicore do not support.", halfDimDAlignNum * 2);
        return false;
    }
