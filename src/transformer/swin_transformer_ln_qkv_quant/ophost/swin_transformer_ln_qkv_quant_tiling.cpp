...
void SwinTransformerLnQkvQuantTilingCompute::SwinTransformerLnQkvQuantSetTilingKey(gert::TilingContext* context)
{
    ...
    OPS_LOG_I(context, "SwinTransformerLnQkvQuant tilingKey is : %ld.", tilingKey);
    return;
}
                                                                        ...
                                                                        gert::TilingContext *context)
{
    ...
    OPS_LOG_I(context->GetNodeName(), "ubSizePlatform: %ld", ubSizePlatform);
    ...
    case ProcessMode::NORMAL_MODE:
        {
            ...
            if ((solutionFlag == true) && (lnSolutionFlag ==true)) {
                ...
                OPS_LOG_I(context->GetNodeName(), "tmpShareBufferForLn: %d", tilingData.get_tmpShareBufferForLn());
            }
            break;
        }
    default:
